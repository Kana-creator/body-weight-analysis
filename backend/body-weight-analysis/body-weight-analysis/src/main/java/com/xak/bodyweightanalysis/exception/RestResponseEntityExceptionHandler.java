...
//	SUCCESS MESSAGE EXCEPTION
	...
	public ResponseEntity<ResponseMessage> successMessageException(
		...
		return ResponseEntity.status(HttpStatus.NOT_EXTENDED).body(responseMessage);
	}
...
//	NOT AUTHORISED EXCEPTION
	...
	public ResponseEntity<ResponseMessage> notAuthorisedException(
			NotAuthorisedException exception, WebRequest request) {
		ResponseMessage responseMessage = new ResponseMessage(
